namespace Conservapp.Models
{
    public class FirstFormModel
    {
        public string nOmbre { get; set; }
        public string dIreccion { get; set; }
        public string rEferencias { get; set; }
        public string tIpodePropiedad { get; set; }
        public string rEsponsabledelInmueble { get; set; }
        public string ZMH { get; set; }
        public string PCH { get; set; }
        public string mOnumentohistorico { get; set; }
        public string rEferenciajuridica { get; set; }
        public string nUmerodeniveles { get; set; }
        public string aReatotal { get; set; }
        public string aReadeconstruccion { get; set; }
        public string nUmerodeaccesos { get; set; }
